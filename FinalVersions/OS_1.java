...
class BSDFileSystem extends FileSystem {
    ...
    public BSDFileSystem() { IOApi = new BsdIOAdapter(new BsdFileSystemIO()); }
...
class NTFileSystem extends FileSystem {
    ...
    public NTFileSystem() { IOApi = new NtIOAdapter( new NtFileSystemIO()); }
...
abstract class File extends FileSystemElement {
    ...
    public String getName(){return name + "." + extension;}

    public void writeData(String data) {
        this.data = data;
        System.out.println("File named " + name + " was written with the data \"" + data + "\"");
    }
    ...
    public void Remove(String elementName) {
        for (int i = 0; i < elements.size(); i++) {
            if (elements.get(i).getName().equals(elementName)) {
                System.out.println(elementName + " is removed from the file system.");
                elements.remove(i);
                return;
            }
        }
...
public class OS_1 {
    public static void main(String[] args) {
        ...
        fileSystemManager.removeElement("f1.txt");
        fileSystemManager.displayFileSystem();
